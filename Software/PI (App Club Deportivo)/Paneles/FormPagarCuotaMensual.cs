...
namespace PI__App_Club_Deportivo_.Paneles
{
    public partial class FormPagarCuotaMensual : Form
    {
        ...
        public FormPagarCuotaMensual(ConexionDB conexionDB)
        {
            InitializeComponent();
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cuota = conexionDB.consultarCuotaMensual(Convert.ToInt32(txtDni.Text));
        ...
        {
            if (conexionDB.abonarCuotaMensual(Convert.ToInt32(txtDni.Text))){
                MessageBox.Show("La Cuota Mensual del Socio " + dni + ", se abono correctamente", "Exito", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
